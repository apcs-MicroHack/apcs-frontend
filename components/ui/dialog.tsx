...
interface DialogContentProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> {
   ...
   * Defaults to "Dialog" if not provided and no DialogTitle exists.
   */
  ariaTitle?: string
}
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, ariaTitle = "Dialog", ...props }, ref) => {
  // Check if children contains a DialogTitle
  const hasDialogTitle = React.Children.toArray(children).some((child) => {
    if (React.isValidElement(child)) {
      // Check direct DialogTitle or DialogHeader containing DialogTitle
      return (
