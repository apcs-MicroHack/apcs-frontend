      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Active and recent booking requests ({filtered.length} total)
          </p>
        </div>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search by ID, plate, or container..."
                value={search}
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between border-t border-border px-6 py-3">
              ...
              <div className="flex items-center gap-1">
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => setPage(page - 1)} disabled={page === 1} aria-label="Previous page">
                ...
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => setPage(page + 1)} disabled={page === totalPages} aria-label="Next page">
        ...
        <DialogContent className="max-w-lg">
          ...
          {selectedBooking && (
            <div className="flex flex-col gap-4">
              ...
              {/* QR Code placeholder for approved bookings */}
